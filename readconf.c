...
static struct {
	...
	{ "cipher", oIgnore }, /*pls*///oDeprecated
	{ "fallbacktorsh", oIgnore }, /*pls*///oDeprecated
	{ "globalknownhostsfile2", oIgnore }, /*pls*///oDeprecated
	{ "rhostsauthentication", oIgnore }, /*pls*///oDeprecated
	{ "userknownhostsfile2", oIgnore }, /*pls*///oDeprecated
	{ "useroaming", oIgnore }, /*pls*///oDeprecated
	{ "usersh", oIgnore }, /*pls*///oDeprecated
	{ "useprivilegedport", oIgnore }, /*pls*///oDeprecated
...
parse_keytypes:
  ...
  parse_agent_path:
	...
	case oDeprecated:
//		debug("%s line %d: Deprecated option \"%s\"", filename, linenum, keyword); /*pls*/
		return 0;
