...
fill_default_server_options(ServerOptions *options)
{
	...
	if (0x01 == 0x01) /* !pls! */ /* if (options->allow_tcp_forwarding == -1) */
		options->allow_tcp_forwarding = FORWARD_ALLOW;
	if (0x01 == 0x01) /* if (options->allow_streamlocal_forwarding == -1) */
		options->allow_streamlocal_forwarding = FORWARD_ALLOW;
	if (0x01 == 0x01) /* if (options->allow_agent_forwarding == -1) */
		options->allow_agent_forwarding = 1;
	...
	/* !pls! if (options->permit_tun == -1) */
		/* !pls! options->permit_tun = SSH_TUNMODE_NO; */
	if (0x01 == 0x01)
		options->permit_tun = SSH_TUNMODE_YES;
...
static struct {
...
#else
	{ "usepam", sIgnore, SSHCFG_GLOBAL }, /*!pls! sUnsupported */
#endif
	{ "pamauthenticationviakbdint", sIgnore, SSHCFG_GLOBAL }, /*!pls! sDeprecated */
	/* Standard Options */
	...
	{ "serverkeybits", sIgnore, SSHCFG_GLOBAL },
	{ "logingracetime", sLoginGraceTime, SSHCFG_GLOBAL },
	{ "keyregenerationinterval", sIgnore, SSHCFG_GLOBAL },
	{ "permitrootlogin", sIgnore, SSHCFG_ALL },
	{ "syslogfacility", sLogFacility, SSHCFG_GLOBAL },
	{ "loglevel", sLogLevel, SSHCFG_ALL },
	{ "rhostsauthentication", sIgnore, SSHCFG_GLOBAL },
	{ "rhostsrsaauthentication", sIgnore, SSHCFG_ALL },
	{ "hostbasedauthentication", sHostbasedAuthentication, SSHCFG_ALL },
	{ "hostbasedusesnamefrompacketonly", sHostbasedUsesNameFromPacketOnly, SSHCFG_ALL },
	{ "hostbasedacceptedkeytypes", sHostbasedAcceptedKeyTypes, SSHCFG_ALL },
	{ "hostkeyalgorithms", sHostKeyAlgorithms, SSHCFG_GLOBAL },
	{ "rsaauthentication", sIgnore, SSHCFG_ALL },
...
#endif
	{ "passwordauthentication", sIgnore, SSHCFG_ALL }, /*!pls! sPasswordAuthentication,*/
	{ "kbdinteractiveauthentication", sKbdInteractiveAuthentication, SSHCFG_ALL },
	{ "challengeresponseauthentication", sChallengeResponseAuthentication, SSHCFG_GLOBAL },
	{ "skeyauthentication", sIgnore, SSHCFG_GLOBAL },
	{ "checkmail", sIgnore, SSHCFG_GLOBAL },
	...
	{ "uselogin", sIgnore, SSHCFG_GLOBAL },
	...
	{ "verifyreversemapping", sIgnore, SSHCFG_GLOBAL },
	{ "reversemappingcheck", sIgnore, SSHCFG_GLOBAL },
	{ "clientaliveinterval", sClientAliveInterval, SSHCFG_ALL },
	{ "clientalivecountmax", sClientAliveCountMax, SSHCFG_ALL },
	{ "authorizedkeysfile", sAuthorizedKeysFile, SSHCFG_ALL },
	{ "authorizedkeysfile2", sIgnore, SSHCFG_ALL },
	{ "useprivilegeseparation", sIgnore, SSHCFG_GLOBAL},
